...
#        self.learner.setSpeed(self.epsilon)
    ...
    def setupSimulationButtons(self, win):
        self.skip = tkinter.Button(win,
        text="skip 50 steps",command=(lambda: self.skip5kSteps()))
        self.skip.grid(row=10, column=3, padx=10)
    ...
    def step(self):
        ...
        newEpsilon = self.learner.epsilon
        if newEpsilon != self.epsilon:
